...
const ch3aEvents: WorldEvent[] = [
  {
    ...
    time: 900,
    name: '废墟调查',
    description: '傍晚时分，图书馆的火终于被扑灭。浓烟还在废墟上方盘旋，卫兵们设了警戒线不让人靠近。莉娅趁马库斯带队去别处巡逻的间隙，从后墙的缺口潜入废墟。在坍塌的书架下，她发现了一道通往地下室的暗门——石砖封堵的痕迹很旧，但火灾烧穿了木框架，暗门的轮廓清晰可见。赫尔曼之前提到的"去图书馆地下室找"，说的就是这里。',
    location: 'library',
  ...
  },
  {
    ...
    time: 960,
    name: '密道与家族秘档',
    description: '暗门后是一条狭窄的石阶密道，墙壁上刻着艾文斯家族的银鹰徽记——和那个神秘旅人信封上的一模一样。密道尽头是一间密室，架上摆满了被蜡封保存的古老文献。莉娅翻开最上面的一份，是十五年前的一封检举信，落款人是"克洛维斯·莫兰，王城大法官首席顾问"。信中详细列出了伪造的"通敌"证据清单。莉娅的手颤抖着——这就是家族蒙冤的铁证。她必须找到莫兰。',
    location: 'library',
    affectedCharacters: ['liya'],
    severity: 'critical',
  },
...
const ch3bEvents: WorldEvent[] = [
  {
    ...
    time: 1080,
    name: '宵禁降临',
    description: '日落时分，镇长宣布宵禁。卫兵在各个路口设置了火把哨卡。赫尔曼把莉娅叫到小屋内室，从壁炉暗格中取出最后几本手稿塞进旧书包，声音压得很低："莉娅，我们今晚必须离开。那些人烧图书馆不是为了毁书——他们是在逼我现身。"他告诉莉娅北门的排水渠在夜间无人看守，那是他年轻时发现的秘密通道。',
    location: 'home',
